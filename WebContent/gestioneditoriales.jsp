			...
			<div class="row">
				<div class="col-12 mt-2">
					<div class="p-4 mb-3 bg-dark text-white">
						<h1 class="text-danger">Gestión de Editoriales - Aplicación de Gestión</h1>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-12">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Gestión de Editoriales</li>
						</ol>
					</nav>
				</div>
			</div>
					...
					<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					  	...
					  	<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
					    	<div class="navbar-nav">
						      	...
						      	<a class="nav-item nav-link active">Gestión de Editoriales <span class="sr-only">(current)</span></a>
				    	...
				    	<tbody>
				    		<%
								for (int i = 1; i < ModeloMVC.insertarEditoriales().size(); i++) {
									String[] datos = ModeloMVC.insertarEditoriales().get(i).split(" - ");
							%>
								<tr>
